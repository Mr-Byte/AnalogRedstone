...
package com.theenginerd.analogredstone.client.model.tileentity
...
import com.theenginerd.analogredstone.client.model.builder._
...
import com.theenginerd.analogredstone.client.model.builder.parts.torchPart
...
object VariableSwitchModel
{
    ...
    private final val VARIABLE_SWITCH_OFF_TEXTURE = new ResourceLocation("analogredstone", "textures/blocks/variable_switch_off.png")
    private final val VARIABLE_SWITCH_ON_TEXTURE = new ResourceLocation("analogredstone", "textures/blocks/variable_switch_on.png")
