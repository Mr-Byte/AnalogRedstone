...
import com.theenginerd.core.common.block.{defineBlockWithTileEntity, BlockSide, ModBlock, ModBlockContainerBase}
...
@defineBlockWithTileEntity[VariableSwitchTileEntity](material = Material.rock) trait VariableSwitchBlock extends ModBlock
{
