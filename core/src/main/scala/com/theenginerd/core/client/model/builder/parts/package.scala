...
import com.theenginerd.core.client.model.builder.shapes.TextureRectangle
import com.theenginerd.core.client.model.Part

package object parts
{
    class TorchPart(torchHeight: Int) extends Part
    {
